...
namespace lab1sharpSasha
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            year.dd = new lab1sharpSasha.Day(dateTimePicker1.Value.Day);
            label2.Text = "";
            label1.Visible = false;
            label2.Visible = false;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            year1.dd = new lab1sharpSasha.Day(dateTimePicker2.Value.Day);
            year2 = new Year(dateTimePicker3.Value.Year);
            year2.mm = new Month(dateTimePicker3.Value.Month);
            year2.dd = new lab1sharpSasha.Day(dateTimePicker3.Value.Day);
            label2.Visible = true;
            ...
            label2.Text += " Месяцев: " + ((int)((day_diff / 30.7))).ToString();
        }
